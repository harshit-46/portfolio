    ...
    return (
        <div className="">
            <div className="flex bg-black border-2">
                ...
                <a href="https://github.com/harshit-46" target='_blank' rel='noreferrer'><button><img src={IMAGES.imgthree} alt="" height="32" width="32" className="mr-10 mt-4 mb-3" /></button></a>
            </div>
        </div>
    )
}
